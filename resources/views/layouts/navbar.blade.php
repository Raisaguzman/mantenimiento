<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="flex-1 md:hidden">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        <li><a href="{{ route('home') }}">Mantenimiento</a></li>
        ...
        <li><a href="{{ route('cronogramas.index') }}" class="nav-link">Cronogramas</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="flex-1 hidden md:flex space-x-4">
    <a href="{{ route('reportes.index') }}" class="btn btn-ghost btn-sm">Mantenimiento</a>
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">Servicios</a>
    <a href="{{ route('equipos.index') }}" class="btn btn-ghost btn-sm">Equipos</a>
    <a href="{{ route('cronogramas.index') }}" class="btn btn-ghost btn-sm">Cronogramas</a>
    <a href="{{ route('dashboard') }}" class="btn btn-ghost btn-sm">Acerca de nosotros</a>
  </div>
